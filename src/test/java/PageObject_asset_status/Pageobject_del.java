...
public class Pageobject_del {
	...
	//*************************************************
	 ...
	 // ///////// Control panel and Asset //////////
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='AssetStatusTableContainer']/div/div[3]/div[2]/span[2]/span[2]")
	...
	@FindBy(xpath = "//*[@id='AssetStatusTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	WebElement clk_first_checkbox_curr;

	// first checkbox delete button
	@FindBy(xpath = "//*[@id='AssetStatusTableContainer']/div/table/tbody/tr[1]/td[7]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String valid_frst_asset_status_del() throws InterruptedException
	{
	...
	public String Valid_mul_asset_status_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='AssetStatusTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_asset_status_del(String UN,String PW)
	{
		UNtext.clear();
		UNtext.sendKeys(UN);
		PassTf.clear();
