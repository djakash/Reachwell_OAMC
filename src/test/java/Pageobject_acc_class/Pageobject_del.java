...
/////////// Control panel and Asset //////////
  ...
  WebElement clk_acc_class;
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='AccountHeadTableContainer']/div/div[3]/div[2]/span[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	//first check box click
	    		@FindBy(xpath="//*[@id='AccountHeadTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='AccountHeadTableContainer']/div/table/tbody/tr[1]/td[7]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String Valid_first_acc_class_delete() throws InterruptedException
	{
	...
	public String Valid_mul_acc_class_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='AccountHeadTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_acc_class_del(String UN,String PW)
	{
		UNtext.clear();
	    UNtext.sendKeys(UN);
	    PassTf.clear();
