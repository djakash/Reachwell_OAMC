...
public class Pageobject_create {
    ...
    //create acc class click
    @FindBy(xpath="//*[@id='AccountHeadTableContainer']/div/div[3]/div[2]/span[4]/span[2]")
    WebElement create_acc_class;
	...
	//click on create acc_class
	public void create_acc_class()
	{
		create_acc_class.click();
	}
	...
	public void Commonprocess_acc_class(String UN,String PW,String parent,String acc_class,String desp)
	{
		UNtext.clear();
        UNtext.sendKeys(UN);
        PassTf.clear();
