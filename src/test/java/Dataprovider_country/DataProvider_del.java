...
public class DataProvider_del {
	...
	{
		List<String[]> Obj = flagRowcount("valid_frst_country_del");
		return Obj.iterator();		
	...
	{
		List<String[]> Obj = flagRowcount("Valid_mul_country_del");
		return Obj.iterator();
	}
	...
	public static List<String[]> flagRowcount(String script_name) throws IOException
	{
		...
		HSSFSheet Scenario_edit = x.Setsheet("Delete_country");
