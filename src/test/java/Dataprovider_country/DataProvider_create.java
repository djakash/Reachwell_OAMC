...
public class DataProvider_create {
	...
	public static Iterator<String[]> Invalidcriti_blnkdata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_country_test_blnk");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Invalidcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_country_test");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Validcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Valid_country_test");
		return Obj.iterator();	
	}
	...
	{
		//"D:\\akash\\salenium\\Reach_OAMC\\Excel-files\\07_Reachwell_masters_Country_Data.xls"
		ExcelReadWrite x=new ExcelReadWrite(System.getProperty("user.dir")+"\\Excel_sheets\\Masters\\07_Reachwell_masters_Country_Data.xls");
		HSSFSheet create_criti = x.Setsheet("create_country");
		...
		for(int xlRow=1;xlRow<=xlRowcount;xlRow++)
		{
			...
			if((Execute_Flag.equals("Y")&&(Scriptname.equals(script_name))))
				...
				arr_login[2]=x.Readvalue(create_criti, xlRow, "country_name");
