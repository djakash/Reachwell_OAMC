...
//main delete button 
@FindBy(xpath="//*[@id='CityTableContainer']/div/div[3]/div[2]/span[1]/span[2]")
...
//blank delete error OK conifirmation
	...
	//first check box click
		@FindBy(xpath="//*[@id='CityTableContainer']/div/table/tbody/tr[1]/td[1]/input")
...
public String getValid_mul_del()
{
	...
	for(int j=1;j<=2;j++)
	{	
		browser.findElement(By.xpath("//*[@id='CityTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
