...
public class DataProvider_del {
	...
	{
		List<String[]> Obj = flagRowcount("valid_frst_employ_desig_del");
		return Obj.iterator();		
	...
	{
		List<String[]> Obj = flagRowcount("Valid_mul_employ_desig_del");
		return Obj.iterator();
	}
	...
	public static List<String[]> flagRowcount(String script_name) throws IOException
	{
		...
		HSSFSheet Scenario_edit = x.Setsheet("Delete_employ_desig");
