...
public class DataProvider_del {
	...
	@DataProvider(name="Valid_first_acc_class_delete")
	public static Iterator<String[]> Valid_first_acc_class_delete() throws IOException
	{
		List<String[]> Obj = flagRowcount("Valid_first_acc_class_delete");
		return Obj.iterator();		
		
	}
	
	
	@DataProvider(name="Valid_mul_acc_class_del")
	public static Iterator<String[]> Valid_mul_acc_class_del() throws IOException
	{
		List<String[]> Obj = flagRowcount("Valid_mul_acc_class_del");
		return Obj.iterator();
	}
	...
	public static List<String[]> flagRowcount(String script_name) throws IOException
	{
		...
		HSSFSheet Scenario_edit = x.Setsheet("Delete_acc_class");
