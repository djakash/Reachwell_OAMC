...
import PageObject_contractor.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_contractor.DataProvider_del.class,groups={"contractor"})
	public void test_Invalid_delcountry_blnk(String TC_ID,String Order,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_con(uname,pwd);//,curr_name);//, Pwd);
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_contractor.DataProvider_del.class,groups={"contractor"})
	public void test_valid_frstcountry_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		...
		Pageobject_del lpob= new Pageobject_del(browser);
		lpob.Commonprocess_con(uname,pwd);
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_contractor.DataProvider_del.class,groups={"contractor"})
