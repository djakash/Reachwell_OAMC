...
/////////// Control panel and location //////////
  ...
  WebElement clk_loc_list;
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='LocationTableContainer']/div/div[3]/div[2]/span[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	//first check box click
	    		@FindBy(xpath="//*[@id='LocationTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='LocationTableContainer']/div/table/tbody/tr[1]/td[8]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String valid_frst_loc_del() throws InterruptedException
	{
	...
	public String Valid_mul_loc_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='LocationTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_loc(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
