...
import PageObject_criticality.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_criticality.DataProvider_del.class,groups={"criticality"})
	public void test_Invalid_editcurr_blnk(String TC_ID,String Order,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_criti(uname,pwd);//,curr_name);//, Pwd);
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_criticality.DataProvider_del.class,groups={"criticality"})
	public void test_valid_frstcurr_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		...
		Pageobject_del lpob= new Pageobject_del(browser);
		lpob.Commonprocess_criti(uname,pwd);
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_criticality.DataProvider_del.class,groups={"criticality"})
