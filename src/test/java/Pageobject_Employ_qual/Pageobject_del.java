...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='QualificationTableContainer']/div/div[3]/div[2]/span[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	@FindBy(xpath="//*[@id='QualificationTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    	WebElement clk_first_checkbox_curr;
	    	
	    	//first checkbox delete button
	    	@FindBy(xpath="//*[@id='QualificationTableContainer']/div/table/tbody/tr[1]/td[7]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String getInvalidemploy_qualResult_blnk()
	{
	...
	public String firstemploy_qual_delete() throws InterruptedException
	{
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='QualificationTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_employ_qual_del(String UN,String PW)
	{
		UNtext.clear();
	    UNtext.sendKeys(UN);
	    PassTf.clear();
