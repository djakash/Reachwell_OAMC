...
public class DataProvider_del {
	...
	@DataProvider(name="valid_frstemployee_del")
	public static Iterator<String[]> Invalideditdata() throws IOException
	{
		List<String[]> Obj = flagRowcount("valid_frstemployee_del");
		return Obj.iterator();		
		
	}
	
	
	@DataProvider(name="Valid_mul_employee_del")
	public static Iterator<String[]> ValideditData() throws IOException
	{
		List<String[]> Obj = flagRowcount("Valid_mul_employee_del");
		return Obj.iterator();
	}
	...
	public static List<String[]> flagRowcount(String script_name) throws IOException
	{
		...
		HSSFSheet Scenario_edit = x.Setsheet("delete_employ");
