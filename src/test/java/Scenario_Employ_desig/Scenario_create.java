...
import Pageobject_Employ_desig.Pageobject_create;
...
//1
	@Test(dataProvider="Invalid_designame_test_blnk",dataProviderClass=Dataprovider_Employ_desig.DataProvider_create.class,groups={"employ_designation"})
	public void test_Validcriti(String TC_ID,String Order,String desig_name,String desig_code,String desp,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_employ_desig(uname,pwd,desig_name,desig_code,desp);//, Pwd);
...
//2
	...
	@Test(dataProvider="Invalid_desigcode_test_blnk",dataProviderClass=Dataprovider_Employ_desig.DataProvider_create.class,groups={"employ_designation"})
...
//3
	@Test(dataProvider="Invalid_designame_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_create.class,groups={"employ_designation"})
...
//4
	@Test(dataProvider="Invalid_desigcode_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_create.class,groups={"employ_designation"})
...
//5
	@Test(dataProvider="Valid_region_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_create.class,groups={"employ_designation"})
