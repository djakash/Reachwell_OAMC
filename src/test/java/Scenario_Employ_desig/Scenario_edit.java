...
public class Scenario_edit extends Base_Class{
	...
	//1
		@Test(dataProvider="Invalid_designame_test_blnk",dataProviderClass=Dataprovider_Employ_desig.DataProvider_edit.class,groups={"employ_designation"})
	...
	//2
		...
		@Test(dataProvider="Invalid_desigcode_test_blnk",dataProviderClass=Dataprovider_Employ_desig.DataProvider_edit.class,groups={"employ_designation"})
	...
	//3
		@Test(dataProvider="Invalid_designame_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_edit.class,groups={"employ_designation"})
	...
	//4
		@Test(dataProvider="Invalid_desigcode_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_edit.class,groups={"employ_designation"})
	...
	//5
		@Test(dataProvider="Valid_region_test",dataProviderClass=Dataprovider_Employ_desig.DataProvider_edit.class,groups={"employ_designation"})
