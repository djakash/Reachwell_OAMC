...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_invoice.DataProvider_del.class,groups={"invoice"})
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_invoice.DataProvider_del.class,groups={"invoice"})
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_invoice.DataProvider_del.class,groups={"invoice"})
