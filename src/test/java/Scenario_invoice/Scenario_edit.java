...
public class Scenario_edit extends Base_Class{
	...
	@Test(dataProvider="dp_Validcriti",dataProviderClass=Dataprovider_invoice.DataProvider_edit.class,groups={"invoice"})
	...
	@Test(dataProvider="dp_Invalidcriti_blnk",dataProviderClass=Dataprovider_invoice.DataProvider_edit.class,groups={"invoice"})
...
@Test(dataProvider="dp_Invalidcriti",dataProviderClass=Dataprovider_invoice.DataProvider_edit.class,groups={"invoice"})
public void test_Invalidcriti(String TC_ID,String Order,String invoice_name,String desp,String Exp_Res) throws IOException
{
	String uname = c1.Reading_Properties("uname");
	String pwd = c1.Reading_Properties("pwd");
	log.info("Executing the testcase "+TC_ID+  "  Order of  "+Order);
