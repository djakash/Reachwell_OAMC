...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='GradeTableContainer']/div/div[3]/div[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	//first check box click
	    		@FindBy(xpath="//*[@id='GradeTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='GradeTableContainer']/div/table/tbody/tr[1]/td[8]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String getInvalidemploy_gradeResult_blnk()
	{
	...
	public String firstemploy_grade_delete() throws InterruptedException
	{
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='GradeTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_employ_grade_del(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
