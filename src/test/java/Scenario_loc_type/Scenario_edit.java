...
import Pageobject_loc_type.Pageobject_edit;
...
public class Scenario_edit extends Base_Class{
	...
	//1
	@Test(dataProvider="Invalid_loctype_test_blnk",dataProviderClass=Dataprovider_loc_type.DataProvider_edit.class,groups={"loc_type"})
	public void Invalid_loctype_test_blnk(String TC_ID,String Order,String loc_type,String desp,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_loc_type_edit(uname,pwd,loc_type,desp);
...
//2
	/*
	@Test(dataProvider="Invalid_loctypename_test",dataProviderClass=Dataprovider_loc_type.DataProvider_edit.class,groups={"loc_type"})
...
//3
	@Test(dataProvider="Valid_loctype_test",dataProviderClass=Dataprovider_loc_type.DataProvider_edit.class,groups={"loc_type"})
