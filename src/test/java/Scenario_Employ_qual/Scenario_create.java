...
import Pageobject_Employ_qual.Pageobject_create;
...
public class Scenario_create extends Base_Class{
	...
	@Test(dataProvider="dp_Validqual",dataProviderClass=Dataprovider_Employ_qual.DataProvider_create.class,groups={"employ_Qualification"})
	public void test_Validqual(String TC_ID,String Order,String qual_name,String desp,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocessqual(uname,pwd,TC_ID, qual_name,desp);//, Pwd);
	...
	@Test(dataProvider="dp_Invalidqual_blnk",dataProviderClass=Dataprovider_Employ_qual.DataProvider_create.class,groups={"employ_Qualification"})
...
@Test(dataProvider="dp_Invalidqual",dataProviderClass=Dataprovider_Employ_qual.DataProvider_create.class,groups={"employ_Qualification"})
