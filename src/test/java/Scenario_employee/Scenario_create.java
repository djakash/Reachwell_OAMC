...
import PageObject_employee.Pageobject_create;
...
//1	
	@Test(dataProvider="Valid_brnch_test",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"employee_list"})
...
//2
    @Test(dataProvider="Invalid_firstname_test_blnk",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"employee_list"})
...
//3	
	@Test(dataProvider="Invalid_empcode_test_blnk",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"employee_list"})
	...
	//4
		@Test(dataProvider="Invalid_login_id_test_blnk",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"employee_list"})
	public void Invalid_login_id_test_blnk(String TC_ID,String Order,String employ_code,String first_name,String login_id,String password,String landline,String e_mail,String qual,String cert,String Exp_Res) throws IOException
	{
		...
		//5	
			@Test(dataProvider="Invalid_same_empcode_test",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"employee_list"})
...
//6
	@Test(dataProvider="Invalid_same_loginid_test",dataProviderClass=Dataprovider_employee.DataProvider_create.class,groups={"branch"})
