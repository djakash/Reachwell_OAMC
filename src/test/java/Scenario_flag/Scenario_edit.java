...
import Pageobject_flag.Pageobject_edit;
...
public class Scenario_edit extends Base_Class{
	...
	@Test(dataProvider="dp_Validcountry",dataProviderClass=Dataprovider_flag.DataProvider_edit.class,groups={"flag"})
	...
	@Test(dataProvider="dp_Invalidcountry",dataProviderClass=Dataprovider_flag.DataProvider_edit.class,groups={"flag"})
	public void test_Invalidcriti(String TC_ID,String Order,String flag_name,String flag_for,String desp,String Exp_Res) throws IOException
	{
		String uname = c1.Reading_Properties("uname");
		String pwd = c1.Reading_Properties("pwd");
		log.info("Executing the testcase "+TC_ID+  "  Order of  "+Order);
	...
	@Test(dataProvider="dp_Invalidcountry_blnk",dataProviderClass=Dataprovider_flag.DataProvider_edit.class,groups={"flag"})
