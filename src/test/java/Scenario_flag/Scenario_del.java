...
import Pageobject_flag.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_flag.DataProvider_del.class,groups={"flag"})
	public void test_Invalid_delflag_blnk(String TC_ID,String Order,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_flag(uname,pwd);//,curr_name);//, Pwd);
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_flag.DataProvider_del.class,groups={"flag"})
	public void test_valid_frstflag_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		...
		Pageobject_del lpob= new Pageobject_del(browser);
		lpob.Commonprocess_flag(uname,pwd);
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_flag.DataProvider_del.class,groups={"flag"})
