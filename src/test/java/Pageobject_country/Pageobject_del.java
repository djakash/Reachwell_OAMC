...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='CountryTableContainer']/div/div[3]/div[2]/span[1]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	//first check box click
	    		@FindBy(xpath="//*[@id='CountryTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='CountryTableContainer']/div/table/tbody/tr[1]/td[7]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='CountryTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_country(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
