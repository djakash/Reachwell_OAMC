...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_zone.DataProvider_del.class,groups={"zone"})
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_zone.DataProvider_del.class,groups={"zone"})
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_zone.DataProvider_del.class,groups={"zone"})
