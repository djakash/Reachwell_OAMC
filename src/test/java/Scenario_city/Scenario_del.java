...
import PageObject_city.PageObject_del;
...
public class Scenario_del extends Base_Class {
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_city.DataProvider_del_city.class,groups={"city"})
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_city.DataProvider_del_city.class,groups={"city"})
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_city.DataProvider_del_city.class,groups={"city"})
