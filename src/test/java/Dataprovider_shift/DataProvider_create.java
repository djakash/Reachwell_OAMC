...
public class DataProvider_create {
	...
	public static Iterator<String[]> Invalidcriti_blnkdata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_shift_test_blnk");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Invalidcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_shift_test");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Validcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Valid_shift_test");
		return Obj.iterator();	
	}
	...
	{
		//"D:\\akash\\salenium\\Reach_OAMC\\Excel-files\\08_Reachwell_masters_shift_Data.xls"
		ExcelReadWrite x=new ExcelReadWrite(System.getProperty("user.dir")+"\\Excel_sheets\\Masters\\08_Reachwell_masters_shift_Data.xls");
		HSSFSheet create_criti = x.Setsheet("create_shift");
		...
		for(int xlRow=1;xlRow<=xlRowcount;xlRow++)
		{
			...
			if((Execute_Flag.equals("Y")&&(Scriptname.equals(script_name))))
				...
				arr_login[2]=x.Readvalue(create_criti, xlRow, "shift_name");
				//arr_login[3]=x.Readvalue(create_criti, xlRow, "hr");
				//arr_login[4]=x.Readvalue(create_criti, xlRow, "min");
