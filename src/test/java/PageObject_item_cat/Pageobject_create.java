...
public class Pageobject_create {
    ...
    //create item_cat click
    @FindBy(xpath="//*[@id='ItemCatalogueTableContainer']/div/div[3]/div[2]/span[4]/span[2]")
    WebElement create_item_cat;
...
//1	
	...
	public String Invalid_brnch_name_test_blnk()//String branch_name,String branch_manager)
	{
...
//6	
	...
	public void Commonprocess_item_cat(String UN,String PW,String branch_name,String item_type,String item_code,String item_name,String desp)
	{
		UNtext.clear();
        UNtext.sendKeys(UN);
        PassTf.clear();
