...
import PageObject_branch.Pageobject_create;
...
//1	
	@Test(dataProvider="Invalid_brnchname_test_blnk",dataProviderClass=Dataprovider_Branch.DataProvider_create.class,groups={"branch"})
...
//2
	@Test(dataProvider="Invalid_locatncode_test_blnk",dataProviderClass=Dataprovider_Branch.DataProvider_create.class,groups={"branch"})
...
//3	
	@Test(dataProvider="Invalid_brnchcode_test_blnk",dataProviderClass=Dataprovider_Branch.DataProvider_create.class,groups={"branch"})
