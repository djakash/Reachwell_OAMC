...
import PageObject_branch.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_Branch.DataProvider_del.class,groups={"branch"})
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_Branch.DataProvider_del.class,groups={"branch"})
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_Branch.DataProvider_del.class,groups={"branch"})
