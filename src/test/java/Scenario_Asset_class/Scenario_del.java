...
import PageObject_Asset_class.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="Invalid_delete_blnk",dataProviderClass=Dataprovider_Asset_class.DataProvider_del.class,groups={"branch"})
	public void Invalid_delete_blnk(String TC_ID,String Order,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_brnch_del(uname,pwd);//,curr_name);//, Pwd);
	...
	@Test(dataProvider="valid_frst_asset_del",dataProviderClass=Dataprovider_Asset_class.DataProvider_del.class,groups={"branch"})
	public void valid_frst_asset_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		String uname = c1.Reading_Properties("uname");
		String pwd = c1.Reading_Properties("pwd");
		log.info("Executing the testcase "+TC_ID+  "  Order of  "+Order);
		...
		Pageobject_del lpob= new Pageobject_del(browser);
		lpob.Commonprocess_brnch_del(uname,pwd);
		String Actual_Res = lpob.valid_frst_asset_del();
	...
	@Test(dataProvider="Valid_mul_del",dataProviderClass=Dataprovider_Asset_class.DataProvider_del.class,groups={"branch"})
	public void Valid_mul_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		String uname = c1.Reading_Properties("uname");
		String pwd = c1.Reading_Properties("pwd");
		log.info("Executing the testcase "+TC_ID+  "  Order of  "+Order);
...
initBrowsersession1();
		...
		Pageobject_del lpob= new Pageobject_del(browser);
		lpob.Commonprocess_brnch_del(uname,pwd);
		String Actual_Res = lpob.Valid_mul_del();		
		sAssert.assertEquals(Exp_Res, Actual_Res);
