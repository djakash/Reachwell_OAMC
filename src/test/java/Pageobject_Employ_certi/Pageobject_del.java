...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='CertificationTableContainer']/div/div[3]/div[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	@FindBy(xpath="//*[@id='CertificationTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    	WebElement clk_first_checkbox_curr;
	    	
	    	//first checkbox delete button
	    	@FindBy(xpath="//*[@id='CertificationTableContainer']/div/table/tbody/tr[1]/td[7]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String getInvalidemploy_certiResult_blnk()
	{
	...
	public String firstemploy_certi_delete() throws InterruptedException
	{
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='CertificationTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_employ_certi_del(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
