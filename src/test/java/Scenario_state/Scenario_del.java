...
import PageObject_state.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_state.DataProvider_del.class,groups={"state"})
	public void test_Invalid_delinvoice_blnk(String TC_ID,String Order,String Exp_Res) throws IOException
	{
		...
		String Actual_Res = lpob.getInvalidinvoiceResult_blnk();
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_state.DataProvider_del.class,groups={"state"})
	public void test_valid_frstinvoice_del(String TC_ID,String Order,String Exp_Res) throws IOException, InterruptedException
	{
		String uname = c1.Reading_Properties("uname");
		String pwd = c1.Reading_Properties("pwd");
		log.info("Executing the testcase "+TC_ID+  "  Order of  "+Order);
		...
		String Actual_Res = lpob.firstinvoice_delete();
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_state.DataProvider_del.class,groups={"state"})
