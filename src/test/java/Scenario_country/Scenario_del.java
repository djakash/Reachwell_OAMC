...
import Pageobject_country.Pageobject_del;
...
public class Scenario_del extends Base_Class{
	...
	@Test(dataProvider="dp_Invaliddel_blnk",dataProviderClass=Dataprovider_country.DataProvider_del.class,groups={"country"})
	...
	@Test(dataProvider="dp_validdel",dataProviderClass=Dataprovider_country.DataProvider_del.class,groups={"country"})
	...
	@Test(dataProvider="dp_Valid_mul_del",dataProviderClass=Dataprovider_country.DataProvider_del.class,groups={"country"})
