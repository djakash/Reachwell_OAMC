...
import PageObject_item_cat.Pageobject_create;
...
//1	
	@Test(dataProvider="Invalid_brnch_name_test_blnk",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
	public void Invalid_brnch_name_test_blnk(String TC_ID,String Order,String branch_name,String item_type,String item_code,String item_name,String desp,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_item_cat(uname,pwd,branch_name,item_type,item_code,item_name,desp);//,hr,min);//, Pwd);
...
//2
	@Test(dataProvider="Invalid_item_code_test_blnk",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
...
//3	
	@Test(dataProvider="Invalid_item_name_test_blnk",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
	...
	//4
		@Test(dataProvider="Invalid_same_item_code",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
		...
		//5	
		@Test(dataProvider="Invalid_same_item_name",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
...
//6	
		@Test(dataProvider="Valid_item_cat_test",dataProviderClass=Dataprovider_item_cat.DataProvider_create.class,groups={"branch"})
