...
public class DataProvider_del {
	...
	@DataProvider(name="valid_frst_asset_del")
	public static Iterator<String[]> valid_frst_asset_del() throws IOException
	{
		List<String[]> Obj = flagRowcount("valid_frst_asset_del");
		return Obj.iterator();		
		
	}
	
	
	@DataProvider(name="Valid_mul_del")
	public static Iterator<String[]> Valid_mul_del() throws IOException
	{
	...
	public static List<String[]> flagRowcount(String script_name) throws IOException
	{
		...
		HSSFSheet Scenario_edit = x.Setsheet("Delete_asset_class");
