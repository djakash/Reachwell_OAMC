...
import Pageobject_loc_loclist.Pageobject_edit;
...
//1	
	@Test(dataProvider="Invalid_loctype_test_blnk",dataProviderClass=Dataprovider_loc_loclist.DataProvider_edit.class,groups={"loc_list"})
	public void Invalid_loctype_test_blnk(String TC_ID,String Order,String parent,String loc_type,String loc_code,String loc_name, String desp,String Exp_Res) throws IOException
	{
		...
		lpob.Commonprocess_loc_edit(uname,pwd);
...
//2	
	@Test(dataProvider="Invalid_loctype_test",dataProviderClass=Dataprovider_loc_loclist.DataProvider_edit.class,groups={"loc_list"})
	public void Invalid_loctype_test(String TC_ID,String Order,String parent,String loc_type,String loc_code,String loc_name, String desp,String Exp_Res) throws IOException
	{
		...
		initBrowsersession1();
		Pageobject_edit lpob= new Pageobject_edit(browser);
		lpob.Commonprocess_loc_edit(uname,pwd);//, Pwd);
...
//3	
@Test(dataProvider="Invalid_locname_test_blnk",dataProviderClass=Dataprovider_loc_loclist.DataProvider_edit.class,groups={"loc_list"})
...
//4
@Test(dataProvider="Invalid_same_locname_test",dataProviderClass=Dataprovider_loc_loclist.DataProvider_edit.class,groups={"loc_list"})
...
//5
@Test(dataProvider="Valid_loc_test",dataProviderClass=Dataprovider_loc_loclist.DataProvider_edit.class,groups={"loc_list"})
