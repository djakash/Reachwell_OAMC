...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='CategoryTableContainer']/div/div[3]/div[2]/span[2]")
	    ...
	    //blank delete error OK conifirmation
	    	...
	    	@FindBy(xpath="//*[@id='CategoryTableContainer']/div/table/tbody/tr[1]/td[2]")
	    	WebElement first_row_text;
	    	
	    	//first check box click
	    		@FindBy(xpath="//*[@id='CategoryTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='CategoryTableContainer']/div/table/tbody/tr[1]/td[8]/button")
...
//////////////////////////////////////////////////////////////////
	...
	public String getInvalidflagResult_blnk()
	{
	...
	public String firstflag_delete() throws InterruptedException
	{
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='CategoryTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_category(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
