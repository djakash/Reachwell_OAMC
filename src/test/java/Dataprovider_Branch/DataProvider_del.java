...
public class DataProvider_del {
	...
	{
		List<String[]> Obj = flagRowcount("valid_frst_branch_del");
		return Obj.iterator();		
	...
	{
		List<String[]> Obj = flagRowcount("Valid_mul_branch_del");
		return Obj.iterator();
	}
	...
	{
		ExcelReadWrite x= new ExcelReadWrite(System.getProperty("user.dir") + "\\Excel_sheets\\Asset\\Reachwell_CP_Branch_Data.xls");
		HSSFSheet Scenario_edit = x.Setsheet("Delete_branch");
