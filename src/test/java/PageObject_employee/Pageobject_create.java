...
public class Pageobject_create {
    ...
    //create employ click
    @FindBy(xpath="//*[@id='EmployeeTableContainer']/div/div[3]/div[2]/span[4]/span[2]")
    WebElement create_employ;
   ...
   //enter e_mail
    ...
    //click arrow ">>"
    @FindBy(xpath="//*[@id='CM_Employee_Create_Form-p-3']/div[2]/div/table/tbody/tr[2]/td/div/div[2]/p[2]")
    WebElement throw1;
  ...
  //enter Exchange_rate
   ...
   //click on relieving date icon
    ...
    //select random date
    @FindBy(xpath="html/body/div[3]/div[1]/table/tbody/tr[4]/td[5]")
    WebElement date_select_1;
    
  //select random date
    @FindBy(xpath="html/body/div[3]/div[1]/table/tbody/tr[4]/td[7]")
    WebElement date_select_2;
    
  //click next
    @FindBy(xpath="//*[@id='CM_Employee_Create_Form']/div[3]/ul/li[2]/a")
    WebElement click_next;
    
  //click finish 
    @FindBy(xpath="//*[@id='CM_Employee_Create_Form']/div[3]/ul/li[3]/a")
    WebElement click_finish;
   
    //1
    //blank employ code error message
	@FindBy(xpath="//*[@id='CM_Employee_Create_Form-p-0']/div[1]/div/label") 	
	WebElement Invalid_empcode_test_blnk;
	
	//2
	//blank first name error message
	@FindBy(xpath="//*[@id='CM_Employee_Create_Form-p-0']/div[2]/div/label")
	WebElement Invalid_firstname_test_blnk;
	
	//3
	//blank login id error message
	@FindBy(xpath="//*[@id='CM_Employee_Create_Form-p-1']/div[1]/div/label")
	WebElement Invalid_login_id_test_blnk;
	
	//4
	//blank password error message
	@FindBy(xpath="//*[@id='CM_Employee_Create_Form-p-1']/div[2]/div/label")
	...
	//click on create employ
		public void click_create_employ()
		{
			create_employ.click();
		}
...
//1	
	...
	public String Valid_brnch_test(String landline,String e_mail,String employ_code,String first_name,String login_id,String password) throws IOException, AWTException
	{
		...
		date_select_2.click();
		browser.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		enter_designation.sendKeys("Unit Manager");
		browser.manage().timeouts().implicitlyWait(05, TimeUnit.SECONDS);
		enter_department.sendKeys("It head7");
		browser.manage().timeouts().implicitlyWait(05, TimeUnit.SECONDS);
		enter_grade.sendKeys("aaaaa");
		browser.manage().timeouts().implicitlyWait(05, TimeUnit.SECONDS);
		click_next();
		browser.manage().timeouts().implicitlyWait(05, TimeUnit.SECONDS);
