...
public class Pageobject_del {
	...
	//*************************************************
	  ...
	  //main delete button 
	    @FindBy(xpath="//*[@id='EmployeeTableContainer']/div/div[3]/div[2]/span[2]")
	  ...
	  //blank delete error OK conifirmation
	    ...
	    WebElement blnk_delete_error;
	    	...
	    	//first check box click
	    		@FindBy(xpath="//*[@id='EmployeeTableContainer']/div/table/tbody/tr[1]/td[1]/input")
	    		WebElement clk_first_checkbox_curr;
	    	
	    		//first checkbox delete button
	    		@FindBy(xpath="//*[@id='EmployeeTableContainer']/div/table/tbody/tr[1]/td[10]/button")
	    		WebElement frst_chkbox_delete;	
	    	
	    		//sub delete button OK confirmation
	    		@FindBy(xpath="//*[@id='DeleteDialogButton']")
...
//////////////////////////////////////////////////////////////////
	...
	public String dp_Invaliddel_blnk1()
	{
	...
	public String valid_frstemployee_del() throws InterruptedException
	{
	...
	public String getValid_mul_del()
	{
		...
		for(int j=1;j<=2;j++)
		{	
			browser.findElement(By.xpath("//*[@id='EmployeeTableContainer']/div/table/tbody/tr["+j+"]/td[1]/input")).click();
	...
	public void Commonprocess_employ_del(String UN,String PW)
	{
		UNtext.clear();
	  UNtext.sendKeys(UN);
	  PassTf.clear();
