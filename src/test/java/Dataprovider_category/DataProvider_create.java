...
public class DataProvider_create {
	...
	public static Iterator<String[]> Invalidcriti_blnkdata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_category_test_blnk");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Invalidcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Invalid_category_test");
		return Obj.iterator();	
	}
	...
	public static Iterator<String[]> Validcritidata() throws IOException
	{
		...
		List<String[]> Obj = flagRowCount("Valid_category_test");
		return Obj.iterator();	
	}
	...
	{
		//"D:\\akash\\salenium\\Reach_OAMC\\Excel-files\\11_Reachwell_masters_category_Data.xls"
		ExcelReadWrite x=new ExcelReadWrite(System.getProperty("user.dir") + "\\Excel_sheets\\Masters\\11_Reachwell_masters_category_Data.xls");
		HSSFSheet create_criti = x.Setsheet("create_category");
		...
		for(int xlRow=1;xlRow<=xlRowcount;xlRow++)
		{
			...
			if((Execute_Flag.equals("Y")&&(Scriptname.equals(script_name))))
				...
				arr_login[2]=x.Readvalue(create_criti, xlRow, "category_name");
				arr_login[3]=x.Readvalue(create_criti, xlRow, "category_code");
