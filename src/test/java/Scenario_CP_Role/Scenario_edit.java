...
import Pageobject_CP_Role.Pageobject_edit;
...
public class Scenario_edit extends Base_Class{
	...
	//1
		@Test(dataProvider="Invalid_rolename_test_blnk",dataProviderClass=Dataprovider_CP_Role.DataProvider_edit.class,groups={"Role"})
		public void test_Validrole(String TC_ID,String Order,String role_name,String parent,String desp,String Exp_Res) throws IOException
		{
			...
			lpob.Commonprocess_Roles_Role_edit(uname,pwd,role_name,parent,desp);//, Pwd);
	...
	//2
		@Test(dataProvider="Invalid_rolename_test",dataProviderClass=Dataprovider_CP_Role.DataProvider_edit.class,groups={"Role"})
		public void Invalid_rolename_test(String TC_ID,String Order,String role_name,String parent,String desp,String Exp_Res) throws IOException
		{
			...
			initBrowsersession1();
			Pageobject_edit lpob= new Pageobject_edit(browser);
			lpob.Commonprocess_Roles_Role_edit(uname,pwd,role_name,parent,desp);
	...
	//3
		@Test(dataProvider="Valid_role_test",dataProviderClass=Dataprovider_CP_Role.DataProvider_edit.class,groups={"Role"})
